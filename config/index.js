export const config = {
  ...
  USERS: [
    {
      ...
      id: "nwosiCUGWxT9or_Ox_imCXcPcNJrxL_IYYGcx1Xf1fE",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "F8m1VCW6o15QItSzyVkCPukl0CyxncOetxQifgV4SXo",
      // 所在省份
      province: "陕西",
      // 所在城市
      city: "宝鸡",
  ...
  SLOT_LIST: [
    ...
    {"keyword": "lover_prattle", contents: [
      ...
      "遇见你，就好像捡到了100斤的运气",
      "浪漫情人节，唯爱一生不变",
      "相扶到老情不变，才是浪漫;死心塌地心不贪，才是蜜甜。相敬如宾真心处，才是满足;白头偕老不辜负，才是幸福",
      "初相见，心相牵，神魂颠倒夜难眠；交往间，情意绵，互道衷肠万语千；光阴转，情不变，携手同行展欢颜；520，我爱你，爱意绵绵今生伴!",
      "我爱你，所以我的眼里只能看见你，我爱你，所以我的世界只围绕着你转。",
      "都说婚姻是爱情的坟墓，可是自从见到你，我愿意将这块墓地开垦成花园。",
      "我爱你，所以卑微到尘埃里，然后开出花来。",
      "喝了你酿的爱情的酒，我愿意沉醉而不愿醒。",
      "宝贝开心的时候，我的心情艳阳高照;宝贝悲伤的时候，我的心情雷雨交加。",
      "因为我爱你，所以我愿感受你所有的感受。",
      "你的微笑，是我这辈子见过最美的景色，我想收藏这样的风景一辈子。",
      "我的人生放荡不羁，不曾为谁停留，但自从遇到你，我会用余生来守护你。",
      "我不想做你人生的插曲，我想成为你一生的主题曲。",
      "我希望几十年后，你还陪在我的身边，在我的臂弯，像个孩子。",
      "我的眼里只有你，自从遇见你，一切繁华都将成为背景。",
